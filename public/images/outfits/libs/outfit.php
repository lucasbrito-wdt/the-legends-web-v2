...
class Outfitter {
	...
	public static $outfitPath = 'outfits/';
	...
	public function outfit($outfit, $addons, $head, $body, $legs, $feet, $mount, $direction = 3, $animation = 1) {
		...
		*/
		...
		if ($mountState == 2 && self::file_exists(self::$outfitPath . $mount_id . '/'.$animation.'_1_1_'.$direction.'.png')) {
			$mount = imagecreatefrompng(self::$outfitPath . $mount_id . '/'.$animation.'_1_1_'.$direction.'.png');
