	...
	protected function outfit($outfit, $addons, $head, $body, $legs, $feet, $mount, $direction = 3, $animation = 1) {
		...
		*/
		...
		if ($addons == 1 || $addons == 3) {
			...
			if(file_exists($outfitPath . $outfit . '/'.$animation.'_' . $mountState . '_2_'.$direction.'_template.png'))
			{
		...
		if ($addons == 2 || $addons == 3) {
			...
			if(file_exists($outfitPath . $outfit . '/'.$animation.'_' . $mountState . '_3_'.$direction.'_template.png'))
			{
