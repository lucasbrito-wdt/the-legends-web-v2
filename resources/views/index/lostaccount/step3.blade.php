        ...
        <div class="container">
            ...
            <div class="main-content">
                <div class="row d-felx justify-content-center">
                    <div class="col-6">
                        <p class="d-block text-center">Seu nome de conta, nova senha e novo e-mail.</p>
                        <div class="row">
                            <div class="col-6">Nome da conta</div>
                            <div class="col-6">{{ htmlspecialchars($account->getName()) }}</div>
                            <div class="col-6">Nova senha</div>
                            <div class="col-6">{{ htmlspecialchars($new_pass) }}</div>
                            <div class="col-6">Novo Endereço de Email</div>
                            <div class="col-6">{{ htmlspecialchars($new_email) }}</div>
                        </div>
                    </div>
                </div>
            </div>
            <a href="{{ route('accountmanagement.login') }}" class="sbutton-blue mt-2 d-block mx-auto">Ir a Conta</a>
            @endif
        </div>
    </div>
</div>
