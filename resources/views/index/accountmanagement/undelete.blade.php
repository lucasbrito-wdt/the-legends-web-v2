...
<div class="container bg-border" style="margin-top:120px">
    ...
    <div class="bg-content">
        <div class="container">
            <div class="bg-title">Cancelar exclusão de personagem</div>
            @if($success)
            ...
            @else
                <div class="main-content">
                    ...
                    @endforeach
                    <form id="submitForm" action="{{ route('accountmanagement.undelete', ['name' => $name]) }}" method="post" class="col-5 mx-auto">
                        @csrf
                ...
                <div class="row">
                    <div class="col-12 mt-1">
                        <button type="submit" class="sbutton-blue" onclick="submitForm()">Restaurar</button>
