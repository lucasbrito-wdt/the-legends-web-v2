...
<div class="container bg-border" style="margin-top:120px">
    ...
    <div class="bg-content">
        <div class="container p-0">
            <div class="bg-title">Cancelando Convite</div>
            @if($errorsView)
            ...
            <div class="main-content mb-2">
                ...
                <form id="formGuild" action="{{ route('guilds.deleteinvite', ['guildId' => $guild->getId(), 'name' => urlencode($player->getName())]) }}" method="POST" class="row d-flex flex-column align-items-center">
                    @csrf
                    <div class="col-5">
                        <p class="m-0">Tem certeza de que deseja cancelar o convite de <b>{{ $player->getName() }}</b>.</p>
                    </div>
                </form>
            </div>
            <div class="d-flex justify-content-center">
                <button id="submitGuild" type="submit" class="sbutton-blue">Cancelar Convite</button>
