...
<div class="container bg-border" style="margin-top:120px">
    ...
    <div class="bg-content">
        <div class="container p-0">
            <div class="bg-title">Alterar MOTD da Guild</div>
            @if($errorsView)
            ...
            <div class="main-content mb-2">
                <form id="formGuild" action="{{ route('guilds.changemotd', ['guildId' => $guild->getId()]) }}" method="POST" class="row d-flex flex-column align-items-center">
                    @csrf
                    <div class="col-5">
                        <p>Aqui você pode alterar MOTD (Mensagem do Dia!) De sua guild.</p>
                        <div class="form-floating mb-3">
                            <textarea type="text" name="motd" class="form-control" id="motd" cols="60" rows="{{ config('otserver.site.guild_description_lines_limit') - 1 }}">{{ $guild->getMOTD() }}</textarea>
